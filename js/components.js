...
export function createHeader(showMenu = false, showBackBtn) {
	return `
        <header class="header">
			${
				showBackBtn
...
function createPagination(
	numItems,
	itemsPerPage = VOCAB_CONFIG.itemsPerPage,
	numPagesDisplay = VOCAB_CONFIG.maxPagesToDisplay
) {
	let paginationHTML = "";
	let pagesHTML = "";
...
export function createRatingButtons(
	...
	return `
		<div class="ratings">
            ...
            <button class="rating-btn" data-action="downvote" data-id=${exampleId} data-type=${exampleType}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M17 14V2"/>
...
export function setupPage(activePage, pageTitle) {
	...
	app.insertAdjacentHTML("afterbegin", createHeader(false, showBackBtn));
